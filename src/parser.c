...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__stx_group_repeat1, 2), SHIFT_REPEAT(34),
  [20] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_group_repeat1, 2), SHIFT_REPEAT(22),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__stx_group_repeat1, 2),
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_group_repeat1, 2), SHIFT_REPEAT(34),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_group_repeat1, 2), SHIFT_REPEAT(14),
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_group_repeat1, 2), SHIFT_REPEAT(7),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_group_repeat1, 2), SHIFT_REPEAT(17),
  ...
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stx_words, 2),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__stx_words, 2),
  ...
  [89] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__stx_words_repeat1, 2), SHIFT_REPEAT(53),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_words_repeat1, 2), SHIFT_REPEAT(26),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__stx_words_repeat1, 2),
  [97] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__stx_words_repeat1, 2), SHIFT_REPEAT(53),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__stx_words_repeat1, 2),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__stx_group, 3),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stx_group, 3),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(58),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(29),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2),
  ...
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__stx_group, 2),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stx_group, 2),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stx_bloc, 1),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stx_bloc, 1),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__linesplit, 4),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__linesplit, 4),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpol8, 3),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpol8, 3),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rbrace, 1),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rbrace, 1),
  ...
  [152] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(62),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(25),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [162] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(66),
  [165] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(28),
  [168] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(66),
  ...
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stx_word, 1),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stx_word, 1),
  ...
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stx_line, 1),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stx_line, 1),
  [201] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_blockquoted_repeat1, 2), SHIFT_REPEAT(64),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_blockquoted_repeat1, 2),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_blockquoted_repeat1, 2), SHIFT_REPEAT(50),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stx_dquo, 1),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stx_dquo, 1),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_blockquoted, 3),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_blockquoted_repeat1, 3),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr1, 2),
  ...
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 5),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 5),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_linefeed, 1),
  ...
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_apply2, 3),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_apply1, 3),
  ...
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_apply2, 6),
  ...
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expri, 1),
  ...
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__codeblock, 5),
  ...
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_applyi, 3),
